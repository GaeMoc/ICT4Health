...
figure, plot(est_class_id_2ClassesMDC, 'o'), hold on, grid on
...
figure, plot(est_class_id_2ClassesBay, 'o'), hold on, grid on
...
% Clustering starting from distances found in MCD -------------------------
...
% 
% figure, subplot(2,1,1)
% % plot(err1(1, :)), hold on, grid on, plot(err2(1, :))
% plot(err1(1, :))
% title('x_k a ')
% % subplot(2,1,2), plot(err1(2, :)), hold on, grid on, plot(err2(2, :))
% subplot(2,1,2), plot(err1(2, :))